...
- All on the same real dataset (350k rows, 85 features) used for the main ML6 submission (4 candidates: baseline, hist_gradient_boosting, xgboost_v1, xgboost_v2)
